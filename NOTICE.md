...
- CLARK / CLARK-News data and its official source linkage
- `BAAI/bge-large-en-v1.5` for dense retrieval and answer embeddings
- `microsoft/deberta-large-mnli` for semantic equivalence clustering
- an OpenAI-compatible hosted generation endpoint used in the archived configs
